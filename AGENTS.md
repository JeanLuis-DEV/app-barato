Este projeto é o novo App Barato, derivado do template oficial da plataforma Apps Simples.

A estrutura comum deve permanecer alinhada ao App Base oficial.
